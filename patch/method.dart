...
class BoundMethod {
  ...
  BoundMethod(MethodMirror mirror) {
    ...
    isDynamic = operation is DynamicOperation;
  ...
  bool isSuitableForRequest(
    ...
    if (pathVariables.length != requestPathVariables.length && !isDynamic) {
      return false;
    }

    return pathVariables
        .every((varName) => requestPathVariables.contains(varName));
  }
}
