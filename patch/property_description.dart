...
class ManagedAttributeDescription extends ManagedPropertyDescription {
  ...
  APISchemaObject documentSchemaObject(APIDocumentContext context) {
    ...
    if (isPrimaryKey && description == null) {
  ...
  String toString() {
    ...
    return "- $name | $type | Flags: ${flagBuffer.toString()} | Description: $description";
  }
...
class ManagedRelationshipDescription extends ManagedPropertyDescription {
  ...
  APISchemaObject documentSchemaObject(APIDocumentContext context) {
    ...
    if (relationshipType == ManagedRelationshipType.hasMany) {
      var result = APISchemaObject.array(ofSchema: relatedType)
        ..isReadOnly = true
        ..isNullable = true;
      if (description != null) {
    ...
    var result = APISchemaObject.object({
  ...
  String toString() {
    ...
    return "- $name -> '${destinationEntity.name}' | Type: $relTypeString | Inverse: ${MirrorSystem.getName(inverseKey)} | Description: $description";
  }
}
