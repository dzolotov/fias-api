...
class DynamicOperation extends Operation {
  const DynamicOperation(method,
      [String pathVariable1,
      String pathVariable2,
      String pathVariable3,
      String pathVariable4])
      : super(
            method, pathVariable1, pathVariable2, pathVariable3, pathVariable4);

  const DynamicOperation.get(
      [String pathVariable1,
      String pathVariable2,
      String pathVariable3,
      String pathVariable4])
      : super(
            "GET", pathVariable1, pathVariable2, pathVariable3, pathVariable4);

  const DynamicOperation.put(
      [String pathVariable1,
      String pathVariable2,
      String pathVariable3,
      String pathVariable4])
      : super(
            "PUT", pathVariable1, pathVariable2, pathVariable3, pathVariable4);

  const DynamicOperation.post(
      [String pathVariable1,
      String pathVariable2,
      String pathVariable3,
      String pathVariable4])
      : super(
            "POST", pathVariable1, pathVariable2, pathVariable3, pathVariable4);

  const DynamicOperation.delete(
      [String pathVariable1,
      String pathVariable2,
      String pathVariable3,
      String pathVariable4])
      : super("DELETE", pathVariable1, pathVariable2, pathVariable3,
            pathVariable4);
}
